...
// void negative_weigth_finder(t_links *begin_way, t_links *way2)
// {
//     t_links *buff_links;

//     buff_links = begin_way->connection_room->links;
//     while (buff_links->connection_room != way2->connection_room)
//         buff_links = buff_links->next;
...
//         negative_weigth_finder(begin_way, way2);
//         // buff_links = way2->connection_room->links;
//         // while(buff_links->connection_room != begin_way->connection_room)
...
//     // if ((*buff_links)->weight == -1)
//     // {
//     //     helper_links = (*queue)->next->vertex->links;
//     //     while (helper_links->connection_room != *current_vertex)
//     //         helper_links = helper_links->prev;
//     //     helper_links->weight = -1;
//     // }
//     (*queue) = (*queue)->next;
//     (*queue)->next = NULL;
// }
...
//         if (/*(current_vertex == st0->end && buff_queue->next == 0 !parents_contain_way(buff_queue->next))*/ (current_vertex != st0->end))
//             criterion = false;
//         i = 1;
//         parents_deleter(st0);
